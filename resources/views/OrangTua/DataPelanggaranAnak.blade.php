                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-md-5">
                        <div class="mb-2 d-flex">
                            <strong style="width: 120px; text-align: left;">Nama Anak</strong>
                    ...
                    <div class="col-md-5">
                        <div class="mb-2 d-flex">
                            <strong style="width: 120px; text-align: left;">No. Hp</strong>
                            <span style="width: 10px; text-align: left;">:</span>
                            <span style="text-align: left;">08231391283</span>
                        </div>
                        <div class="mb-2 d-flex">
                            <strong style="width: 120px; text-align: left;">Alamat</strong>
                            <span style="width: 10px; text-align: left;">:</span>
                            <span style="text-align: left;">Cianjur</span>
                        </div>
                    </div>
                </div>
